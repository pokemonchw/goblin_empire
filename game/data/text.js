...
(function (game) {
    ...
    var TAB_TEXT = {
        ...
        tutorial: {
            name: "新手教程",
            description: "查看第一局的发展顺序和常见问题。"
        }
    };

    /**
     * @typedef {Object} TutorialSectionText
     * @property {string} title - 教程阶段标题。
     * @property {string} goal - 本阶段应达成的目标说明。
     * @property {string[]} steps - 按顺序显示的操作建议数组。
     */

    // TutorialSectionText[] 新手教程阶段列表：按第一局推荐推进顺序展示。
    var TUTORIAL_SECTIONS = [
        {
            title: "1. 稳住地穴口粮",
            goal: "目标：让菌菇的每秒变化长期为正。",
            steps: [
                "选择正常模式，用采菌、捡朽木和搬碎石补足当前缺口。",
                "优先建造菌菇床，持续留意菌菇库存、容量和每秒变化。",
                "资源满仓后产出会溢出；看到库存贴近上限时准备仓储。"
            ]
        },
        {
            title: "2. 建泥棚并扩充氏族",
            goal: "目标：准备住房，迎接第一只哥布林。",
            steps: [
                "收集至少 5 朽木并建造泥棚，解锁氏族标签。",
                "泥棚只提供住房；使用俘虏的培育新生并等待孕育完成。",
                "扩张人口前确认有空余住房，并保持菌菇持续盈余。"
            ]
        },
        {
            title: "3. 分配职业并开始研究",
            goal: "目标：稳定基础产出，打开早期科技树。",
            steps: [
                "缺朽木就安排伐木工，缺碎石就安排搬运工；保留空闲人口也能提供劳力。",
                "用 25 朽木建造涂鸦墙，安排涂鸦学徒生产粗识。",
                "先研究刻痕，再按瓶颈选择采菌、枯木培植、窝棚搭建或采矿。"
            ]
        },
        {
            title: "4. 控制容量与劳力",
            goal: "目标：避免生产链无声停摆。",
            steps: [
                "库存不增长时先查是否满仓，再查劳力是否过载。",
                "劳力为负时，除菌菇床外的生产建筑会停产；增加人口或减少启用建筑。",
                "建筑价格会随拥有数量上涨，购买前查看实际成本，不要一次花空口粮。"
            ]
        },
        {
            title: "5. 进入矿业与工坊",
            goal: "目标：建立矿物到工业材料的加工链。",
            steps: [
                "研究采矿，建浅矿井并安排矿工，取得煤渣与铁矿。",
                "在工坊按下一座关键建筑倒推材料，不必平均囤积每种加工品。",
                "产物满仓会卡住配方；自动制作也会真实消耗上游原料。"
            ]
        },
        {
            title: "6. 迈向城邦与深渊",
            goal: "目标：用外部系统补充稀有资源，准备帝国迁徙。",
            steps: [
                "贸易负责关系、善名和稳定收益；掠夺负责战利品、俘虏、战兽与恶名。",
                "签订契约、献祭或远征前先检查持续代价、口粮和队伍风险。",
                "研究迁徙法典并打开深渊门；当遗产足以明显加速下一局时再迁徙。"
            ]
        }
    ];
    ...
    var TEXT_REGISTRY = {
        ...
        effects: EFFECT_TEXT,
        tabs: TAB_TEXT,
        tutorialSections: TUTORIAL_SECTIONS,
